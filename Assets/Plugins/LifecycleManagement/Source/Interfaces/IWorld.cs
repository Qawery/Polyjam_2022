...
namespace Lifecycle
{
	public interface IWorld
	{
		...
		ComponentType Instantiate<ComponentType>(ComponentType prefab, Vector3 position, Quaternion rotation, System.Action<ComponentType> initializer, Transform parent = null) where ComponentType : MonoBehaviour;
